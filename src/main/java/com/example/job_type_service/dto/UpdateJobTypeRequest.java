...
@Schema(description = "Request object for updating an existing job type")
public class UpdateJobTypeRequest {
    ...
    @Schema(description = "User who is updating the job type", example = "admin", required = true)
    @NotBlank(message = "Update by is required")
    @Size(max = 128, message = "Update by must not exceed 128 characters")
    private String updateBy;

    public UpdateJobTypeRequest() {}

    public UpdateJobTypeRequest(String code, String description, String updateBy) {
        this.code = code;
